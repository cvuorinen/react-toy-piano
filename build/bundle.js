	...
	var App = (function (_React$Component) {
	    ...
	    _createClass(App, [{
	        ...
	        value: function nextSong() {
	            ...
	            this.setState(_extends({}, this.state, { song: this.songs[next] }));
	        }
	    }, {
	        key: 'selectColor',
	        value: function selectColor(newColor) {
	            this.setState(_extends({}, this.state, { color: newColor }));
	        }
	    }, {
	        key: 'toggleLabels',
	        value: function toggleLabels() {
	            this.setState(_extends({}, this.state, { labels: !this.state.labels }));
	        }
	    }, {
	        key: 'getClassName',
